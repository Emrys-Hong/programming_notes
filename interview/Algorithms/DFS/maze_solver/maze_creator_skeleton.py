...
class MazeCreator:
    ...
    def create_maze(self, end):
        ...
        ###################################################################
        #                        YOUR CODE HERE                           #
        #  Populate the maze with paths, a start point, and an end point. #
        ###################################################################

        # 'O' denotes an empty tile, 'B' denotes a start tile and 'E' denotes an ending tile
        # e.g., to create an empty tile at x=3, y=5:
        # maze.matrix[3][5] = 'O'
