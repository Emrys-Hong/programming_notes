## finished the course on July 19th 2018

[url for my certificate](https://www.coursera.org/account/accomplishments/specialization/SBS26KG3T5YX)
...
2. [keras documentation](https://keras.io/) is really useful you should read it.

3. if you want to download all the file and run locally run this command in jupyter: ```!tar chzf notebook_ex2.tgz --exclude notebook_ex2.tgz *```
or you can follow [this url](https://www.coursera.org/learn/neural-networks-deep-learning/discussions/forums/a-1G6KlmEeeYBA47k-OCuA/threads/eUKI3fV9EeePKRLsJq13Wg)

4. here are [papers](https://github.com/iitrsamrat/deeplearning.ai.sequence-model-papers/blob/master/index.md) in mentioned sequence models, since my related area is NLP, i am reading these papers.
...
Unified, Real-Time Object Detection](https://arxiv.org/pdf/1506.02640.pdf), [YOLO](https://arxiv.org/pdf/1612.08242.pdf)
 ...
 ## finally:
 I regret seeing code from [enggen's repo](https://github.com/enggen/Deep-Learning-Coursera), I should have figure it out myself.
